...
const ROUTES = [
  [new RegExp("themealdb\\.com/.*list\\.php\\?i=list"), 'themealdb-ingredients.json'],
  [new RegExp("thecocktaildb\\.com/.*list\\.php\\?i=list"), 'thecocktaildb-ingredients.json'],
  [new RegExp("themealdb\\.com/.*list\\.php\\?c=list"), 'themealdb-categories.json'],
  [new RegExp("thecocktaildb\\.com/.*list\\.php\\?c=list"), 'thecocktaildb-categories.json'],
  [new RegExp("themealdb\\.com/"), 'themealdb-search.json'],
  [new RegExp("thecocktaildb\\.com/"), 'thecocktaildb-search.json'],
];
