...
module.exports = async (req, res, next) => {
  ...
  if (validationError) {
    return next(validationError); // Enviamos o erro para o middleware de erro
  }

  const { username, password } = req.body;

  // Pedimos para o service armazenar os dados. Em troca, recebemos o resultado da ação
  ...
  // Se tiver algum erro, e o código for "usernameExists", retornamos um 409 Conflict com a mensagem do erro
